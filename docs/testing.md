...
| `spring-read-localization.test.ts`        | map/search/full-detail services                                                                                       | per-document row selection, invalid-source logging/degradation, visible global-config failures, source fallback, distance/limit behavior and query preservation    |

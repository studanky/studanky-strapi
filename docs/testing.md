...
| Spring reads                     | Bounding-box and search service behavior, normalization, geographic distance, candidate limits, required-locale controller validation, base and regional language tags, detail sanitization, preview boundaries, locale fallback, and source-metadata degradation. |
